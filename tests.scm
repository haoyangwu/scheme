...
(cdr (list 12 34 56 78))
;expect (34 56 78)

(car (cdr (cdr (list 12 34 56 78))))
;expect 56

(car (car (list 12 34 56 78)))
;expect #Error: argument 0 of car has wrong type (int)
...
(begin 100 (quote scheme))
;expect scheme

(begin (* 10 10) 'python)
;expect python

(begin (define x *) ((lambda (y z) (x y z)) 4 9))
;expect 36

(begin (define double (lambda (x) (+ x x))) (double 10))
;expect 20

(lambda x (* 5 (+ 3 2)) x)
;expect #Error: malformed list: x

(lambda (x) (+ (/81 9) (*3 3)))
;expect lambda (x) (+ (/81 9) (*3 3)))

(begin (define (p) (/ (+ 2 (*2 5)) 3) p))
;expect p

p
;expect (lambda () (/ (+ 2 (*2 5)) 3) p)
...
(lambda (cs) compsci)
;expect (lambda (cs) compsci)

(lambda (r y) nil)
;expect (lambda (r y) ())

(lambda (if x) if)
;expect (lambda (if x) if)

(lambda  a (if x)) a)
;expect #Error: malformed list: a
...
(or false (and (> 1 0) 3 false) (and #t (> 2 1) (* 3 5)))
;expect 15
...
(zip '((32 54) (65 87) (91 20) (75 84)))
;expect ((32 65 91 75) (54 87 20 84))
